		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#atsempemployeebudget-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atsempemployeebudget-display": {
								"semanticObject": "atsempemployeebudget",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ats.emp.employeebudget",
									"url": sap.ui.require.toUrl("ats/emp/employeebudget")
								}
							}
						}
					}
